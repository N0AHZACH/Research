...
CSV_FILENAME = f"results/exp15_qwen_stochastic_metrics_{TIMESTAMP}.csv"
SAVE_DIR     = f"checkpoints/exp15_qwen_stochastic_output_{TIMESTAMP}"

def main():
    print(f"\n{'='*70}\n  EXP15: QWEN2.5-3B FULL-DEPTH STOCHASTIC (36 Layers)\n{'='*70}")
    ...
    handles = []
    # Qwen has 36 layers, OpenLLaMA has 26. We skip dropping the first 4.
            ...
            for batch in pbar:
                ...
                if global_step % EVAL_EVERY_STEPS == 0:
                    ...
                    with open(CSV_FILENAME, "a", newline="") as f:
                        csv.writer(f).writerow([epoch, global_step, loss.item() * GRAD_ACCUM, val_loss, ppl, 18.0, 0.0])
