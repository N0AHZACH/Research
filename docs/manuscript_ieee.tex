...
\begin{enumerate}
    ...
    \item \textbf{Scale to larger models.} Validation on a 7B model (e.g., Llama-3-8B or Mistral-7B) with richer datasets is needed to confirm the behavior observed in 1B and 3B architectures.
\end{enumerate}
